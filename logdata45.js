    ...
    function addClipboardFunctionality() {
        $("pre").each(function() {
            ...
            if (!$this.prev().hasClass('clipboard-button')) {
                var buttonHtml = $('<button class="clipboard-button btn btn-secondary btn-sm" style="position: absolute; top: 0.5rem; right: 0.5rem; z-index: 10000;"><i class="fa fa-clipboard" aria-hidden="true"></i></button>').click(function() {
                    var text = $this.text();
