$(document).ready(function () {
    ...
    function enableUIComponents() {
        ...
        'pointer-events': 'auto', // Reset to default behavior which allows pointer events
        'opacity': '1', // Typically, you'd reset opacity to 1 to make it fully opaque
    ...
    function handleStartExam(response) {
        ...
        $('.timer-container').removeClass('disabled'); // Remove the 'disabled' class to activate
        if (!examTimerInterval) {
            examTimerInterval = setInterval(updateExamTimer, 1000);
        }
    }
