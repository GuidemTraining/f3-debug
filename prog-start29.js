$(document).ready(function () {
    ...
    function disableUIComponents() {
        $('.accordion-collapse, .guidem-button, .custom-button').prop('disabled', true).css('opacity', '0.5');
        $('.accordion-button').addClass('collapsed').attr('aria-expanded', "false");
    }

    // Function to enable UI components
    function enableUIComponents() {
        $('.accordion-collapse, .guidem-button, .custom-button').prop('disabled', false).css('opacity', '');
