$(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.examSessionActive === "yes") {
                    ...
                    // Check if exam start time is available in local storage
                    if (!localStorage.getItem('examStartTime')) {
                        // Store exam start time in local storage
                        localStorage.setItem('examStartTime', response.examData.startTime);
                    }
                } else {
    ...
    // Fetch exam session status when the document is ready
