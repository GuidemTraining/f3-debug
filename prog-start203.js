$(document).ready(function () {
    ...
    function disableUIComponents() {
        $('.guidem-master-container .guidem-button,.btn-cwr, .guidem-master-container input[type="text"], .guidem-master-container .accordion-button')
    .prop('disabled', true).css('opacity', '0.5');
        ...
        $('.guidem-master-container .btn-cwr').prop('disabled', false).css('opacity', '');
