$(document).ready(function () {
    ...
    function enableUIComponents(response) {
        // Check if the response object and the completedItems property exist
        if (response && response.completedItems) {
            ...
            // Handle the case where the completedItems property is undefined or missing
            console.error("The 'completedItems' property is undefined in the response object.");
