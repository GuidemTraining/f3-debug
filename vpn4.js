$(document).ready(function () {
    ...
    function genvpn() {
        console.log('Preparing data for VPN generation');
        $('#loadingIcon').css('display', 'inline-block');
        $('#generateVpnButton').prop('disabled', true).text('Generating...');

        console.log('Sending AJAX request to generate VPN...');
        $.ajax({
            ...
            beforeSend: function() {
                console.log('AJAX request for VPN generation is about to be sent.');
            },
