$(document).ready(function () {
    ...
    function sendExamActionRequest(action) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (action === 'start') {
                    handleStartExamResponse(response.examData);
                }
    ...
    // Function to handle the response after starting the exam
    function handleStartExamResponse(examData) {
        console.log('Received exam data:', examData);
        // Update UI or perform actions based on the exam data
    }
