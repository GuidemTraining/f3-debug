    ...
    function updateUIComponents() {
        ...
        $('.guidem-form').each(function() {
            ...
            if (isQuestionCompleted(formQuestionId)) {
                ...
                $form.find('.guidem-button, .guidem-hint-button').prop('disabled', true)
                    .css('opacity', '0.8');
                ...
                $form.find('.guidem-master-container .guidem-button, .guidem-master-container input[type="text"], .accordion-button').prop('disabled', false).css('opacity', '1');
